# Architecture & Topology - Machine Learning Compatible Game Engine Lab
...
```mermaid
graph TD
    PersonalHub[dragosandreibobu.github.io] --> OrgPage[Machine-Learning-Compatible-Game-Engine.github.io]
